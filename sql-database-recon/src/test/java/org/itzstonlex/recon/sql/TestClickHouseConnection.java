...
public class TestClickHouseConnection {
    ...
    public static void main(String[] args) {
        ...
        usersTable.selectAll().thenAccept(response -> {
            ...
            if (!response.next()) {
                ...
                connection.getLogger().info("ClickHouse Response find!");
    ...
    public static class ClickHouseEventHandler extends ReconSqlEventListenerAdapter {

        private final ClickHouseDatabaseConnection connection;

        public ClickHouseEventHandler(ClickHouseDatabaseConnection connection) {
