...
public class HttpDownloadTest {
    ...
    public static final String DOWNLOAD_PROCESS_FORMAT  = "Download: [%s/%s KB] (%s KB/sec)\n";
    ...
    private static void startDownload(Path target) {
        ...
        boolean isSuccess = HTTP_DOWNLOAD_SERVICE.downloadSync(BUNGEECORD_REPOSITORY, target,
                context -> System.out.printf(DOWNLOAD_PROCESS_FORMAT, context.getCurrentKilobytes(), context.getMaxKilobytes(), context.getSpeed()));
